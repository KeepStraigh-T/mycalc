...
enum {add = '+', substruct = '-', multiply = '*', divide = '/', modulo = '%', pleft = '(', pright = ')'}; //operator value
typedef enum {err = -1, ok = 0, eof = 1} TokenState; //flags
typedef enum {number = 666, operator = 777} TokenType;
